<template>
  <div id="navigation" class="w-full fixed bottom-0 md:bottom-auto md:left-0 md:top-0 md:h-screen flex justify-center bg-black justify-around md:flex-col md:justify-between">
    ...
    <div class="nav-items flex md:flex-col">
      <router-link
        ...
        class="nav-item hover:border-green-700">
        <a :href="href" @click="navigate" :class="[isActive && 'nav-item--selected']">
